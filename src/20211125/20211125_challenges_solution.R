...
coltab(lu_nara_2016) <- legend$color
...
natura2000 <- st_read("./data/20211125/20211125_protected_areas.gpkg",
                      layer = "ps_hbtrl")
natura2000 <- st_transform(natura2000, crs = 4313)
min_max_lu <- exactextractr::exact_extract(x = lu_nara_2016,
                                  y = natura2000,
