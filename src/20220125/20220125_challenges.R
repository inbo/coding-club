...
#' get observations of taxa _Impatiens glandulifera_ and  _Hydrocotyle
#' ranunculoides_ from florabank db:



#' 3. Using inbodb and still being lazy, search recordings collected during
#' survey `"ABS-LIM2011"` in `inboveg` database
...
#' `Latitude` between 50.9 and 51.1 and `Longitude` between 3.9 and 3.5. Show
